...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_QWERTY] = LAYOUT_split_3x5_3(
        ...
        /*NO-KEY*/ /*NO-KEY*/ KC_ESC, LT(_NAV,KC_BSPC), LT(_MOUSE,KC_TAB), /**/ LT(_SYM,KC_ENT),  LT(_NUM,KC_SPACE),     LT(_FUN,KC_DEL)  /*NO-KEY*/    /*NO-KEY*/
    ),
    /* Navigation */
    [_NAV] = LAYOUT_split_3x5_3(
        XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,    XXXXXXX,         XXXXXXX,    XXXXXXX,    KC_UP,       XXXXXXX,    XXXXXXX,
        XXXXXXX,   KC_LALT,   KC_LCTL,  KC_LSFT,    XXXXXXX,         XXXXXXX,    KC_LEFT,    KC_DOWN,    KC_RIGHT, XXXXXXX,
        XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,    XXXXXXX,         XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
        /*NO-KEY*/ /*NO-KEY*/ XXXXXXX,   XXXXXXX,  _______,          KC_ENT,     KC_BSPC,    KC_DEL  /*NO-KEY*/ /*NO-KEY*/
    ),
    /* Mouse */
    [_MOUSE] = LAYOUT_split_3x5_3(
        XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,    XXXXXXX,         XXXXXXX,    XXXXXXX,    MS_UP,      XXXXXXX,    XXXXXXX,
        XXXXXXX,   KC_LALT,   KC_LCTL,  KC_LSFT,    XXXXXXX,         XXXXXXX,    MS_LEFT,    MS_DOWN,    MS_RGHT,    XXXXXXX,
        XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,    XXXXXXX,         XXXXXXX,    MS_WHLL,    MS_WHLD,    MS_WHLU,    MS_WHLR,
        /*NO-KEY*/ /*NO-KEY*/    XXXXXXX,  XXXXXXX,    _______,         MS_BTN1,    MS_BTN2,    MS_BTN3   /*NO-KEY*/   /*NO-KEY*/
    )
//     /* Number */
